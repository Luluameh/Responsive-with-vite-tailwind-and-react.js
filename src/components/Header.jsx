...
const Header = () => {
  return (
    <>
      <div className=" l:ml-[15%] bg-white rounded shadow-sm m-auto  xxl:ml-[10%]">
        <div className="flex p-8 justify-between ml-16 mr-16">
          <div>
            ...
            <p className="text-sm  text-[#B8B9BD] font-normal">
     ...
     "
          >
            <button className="l: font-normal  font-inter   text-white bg-black  p-1 gap-2  rounded-md text-sm ">
              ADD MEMBER
            </button>
          </div>
        </div>
